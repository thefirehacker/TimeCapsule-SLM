  ...
  phases:
    preBuild:
      commands:
        ...
        - echo "Checking src/components/ui directory:"
        - ls -la src/components/ui/ | head -10
        - echo "Checking specific UI components:"
        - ls -la src/components/ui/card.tsx src/components/ui/button.tsx src/components/ui/badge.tsx || echo "Some UI components not found"
    build:
      commands:
        - echo "🔨 Building Next.js application..."
        - echo "🌍 Final environment variables verification:"
        ...
        - echo "🔐 VERBOSE Authentication Variables Debug:"
        - echo "================================================"
        ...
        - echo "================================================"
        - echo "🔍 Variable Validation Checks:"
        - 'if [ -z "$AUTH_SECRET" ]; then echo "❌ AUTH_SECRET is empty"; else echo "✅ AUTH_SECRET is set"; fi'
        - 'if [ -z "$AUTH_GITHUB_ID" ]; then echo "❌ AUTH_GITHUB_ID is empty"; else echo "✅ AUTH_GITHUB_ID is set"; fi'
        - 'if [ -z "$AUTH_GITHUB_SECRET" ]; then echo "❌ AUTH_GITHUB_SECRET is empty"; else echo "✅ AUTH_GITHUB_SECRET is set"; fi'
        - 'if [ -z "$AUTH_GOOGLE_ID" ]; then echo "❌ AUTH_GOOGLE_ID is empty"; else echo "✅ AUTH_GOOGLE_ID is set"; fi'
        - 'if [ -z "$AUTH_GOOGLE_SECRET" ]; then echo "❌ AUTH_GOOGLE_SECRET is empty"; else echo "✅ AUTH_GOOGLE_SECRET is set"; fi'
        - echo "================================================"
        - npm run build
