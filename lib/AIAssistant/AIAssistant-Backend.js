  ...
  async initializeOllama(customUrl = null) {
    try {
      ...
      if (customUrl) {
        ...
        console.log('🔍 DEBUG: No custom URL provided, using default:', ollamaUrl);
      }
      ...
      if (error.name === 'AbortError') {
        ...
        errorMessage = 'Cannot connect to Ollama server. Check if Ollama is running and CORS is enabled.';
