...
window.BubblSpaceNavbar = {
  ...
  styles: `
    ...
    @media screen and (max-width: 768px), screen and (max-device-width: 768px) {
      ...
      /* FORCE MOBILE INDICATOR - Red border for debugging */
      ...
      /* FORCE HAMBURGER LINES - MAXIMUM VISIBILITY */
      html body .sketchpad-nav .mobile-menu-toggle span,
      html body div.sketchpad-nav button.mobile-menu-toggle span {
        display: block !important;
        width: 24px !important;
        height: 3px !important;
        background: white !important; /* WHITE ON RED BACKGROUND */
      ...
      <div class="mobile-nav-menu" id="mobileNavMenu">
        ...
        <div class="mobile-nav-links">
          ...
          <div class="mobile-nav-section">
            ...
            <a href="Canvas.html" ${isPlaygroundActive ? 'class="active"' : ''}>
              <span>🎮</span>
              <span>Playground</span>
            </a>
          </div>
