    ...
    try {
      ...
      modalContent.innerHTML = `
        ...
        <div class="document-list" id="searchResultsList">
          <!-- Results will be populated programmatically -->
        </div>
      `;
    ...
    results.forEach((result, index) => {
      ...
      resultItem.innerHTML = `
        ...
        <div class="document-actions">
          ...
          <button class="doc-action-btn doc-btn" data-document-id="${result.documentId}">📄 Full Doc</button>
        </div>
      `;
      ...
      if (chunkBtn) {
        chunkBtn.addEventListener('click', (e) => {
          e.preventDefault();
          try {
            this.previewChunk(result.documentId, chunkIndex, content);
          } catch (error) {
      ...
      if (docBtn) {
        docBtn.addEventListener('click', (e) => {
          e.preventDefault();
          try {
            this.previewDocument(result.documentId);
          } catch (error) {
