        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              These Terms of Use govern your use of TimeCapsule, an AI-powered
              research and learning platform provided by AIEDX Private Limited.
              By using TimeCapsule, you agree to these Terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 ml-4">
              ...
              <li>
                <strong>Credit-Based Mode:</strong> Users can purchase credits
                from TimeCapsule, allowing them to access AI services without
          ...
          <section className="mb-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 ml-4">
                  <li>You may use our services through purchased credits.</li>
                  <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              Content generated by AI models may contain errors or inaccuracies.
              TimeCapsule does not guarantee the reliability or factual
              correctness of AI outputs. Users should verify all critical
